...
static const char *const yytname[] =
{
  ...
  "MUL", "DIV", "LPAREN", "RPAREN", "$accept", "expression", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* expression: expression ADD expression  */
#line 14 "calc.y"
                              { printf("Result: %d\n", yyvsp[-2] + yyvsp[0]); }
#line 1114 "calc.tab.c"
    break;

  case 3: /* expression: expression SUB expression  */
#line 15 "calc.y"
                                { printf("Result: %d\n", yyvsp[-2] - yyvsp[0]); }
...
#line 1126 "calc.tab.c"
  ...
  case 5: /* expression: expression DIV expression  */
#line 17 "calc.y"
                                { 
        if (yyvsp[0] == 0) {
